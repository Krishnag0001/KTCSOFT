...
<body>
 ...
 -->
       ...
       <form action="sql_add_customer.php" method="POST">  
                    
                            <center><h3 class="box-title">Add Customer </h3> 
...
<?php
      ...
      include 'config.php';
                               ...
                               echo '<table width="400px"><tr><td>Customer Name:</td> <td><input type="text" class="form-control" id="customer_name" name="customer_name">';
echo '</td></tr>
...
<tr><td>Customer GST/PAN/Adhar No.:</td> <td><input type="text" class="form-control" id="customer_gst" name="customer_gst"></td></tr>
</table>';
?>
<br><br>
