...
echo '</td></tr>
<tr><td>HSN Code:</td> <td><input type="text" class="form-control" id="hsn_code" name="hsn_code"></td></tr>';
...
<tr><td>GST in Percent:</td> <td><input type="number" step="any" class="form-control" id="gst_per" name="gst_per" required></td></tr>
