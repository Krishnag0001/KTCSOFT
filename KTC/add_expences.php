...
<body>
 ...
 -->
       ...
       <form action="sql_add_expences.php" method="POST">  
                    
                            <center><h3 class="box-title">Add Expences</h3> 
...
<?php
     ...
     // $query_importer = "SELECT * FROM customer ORDER BY customer_name ASC";
      //$result_importer = mysqli_query($conn,$query_importer);
                               ...
                               echo '<table width="400px"><tr><td>Expence Name:</td> <td><input type="text" class="form-control" id="expence_name" name="expence_name">';
echo '</td></tr>
<tr><td>Amount:</td> <td><input type="number" step="any" class="form-control" id="amount" name="amount"></td></tr>

<tr><td>Comment:</td> <td><input type="text" class="form-control" id="comment" name="comment"></td></tr>
...
?>
<br><br>
<input type="submit" value="Add Expence" id="save_customer_name" name="save_customer_name" class="btn btn-primary">
 </center>
</form>  
</body>  
</html>  
