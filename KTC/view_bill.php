...
<li  class="dropdown"><a href="add_customer.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Create Account <span class="caret"></span></a>
 ...
 -->
       ...
       <form action="view_all_bills.php" method="POST">  
                    
                            <center><h3 class="box-title">View Bill</h3> 
...
<?php
      ...
      include 'config.php';
                               ...
                               echo '<table width="400px"><tr><td>Invoice Number:</td> <td><input type="number" class="form-control" id="invoice_number" name="invoice_number">';
// echo '</td></tr><td>To Date:</td> <td><input type="date" class="form-control" id="date2" name="date2"></td>
                               echo '</td></tr></table>';
?>
<br><br>
<input type="submit" value="View Bill" id="view_bill" name="view_bill" class="btn btn-primary">
 </center>
</form>  
</body>  
</html>  
