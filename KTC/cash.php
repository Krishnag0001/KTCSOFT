...
<body>
 ...
 -->
       ...
       <form action="cash_paid.php" method="POST">  
                    
                            <center><h3 class="box-title">Cash Payment </h3> 
...
echo '<tr><td>Cash Amount:</td><td> <input type="number" class="form-control" id="cash" name="cash"></td></tr>';
echo '<tr><td>Date:</td><td> <input type="date" class="form-control" id="date1" name="date1" value="'.date("Y-m-d").'"></td></tr></table>';
?>
<br><br>
<input type="submit" value="Cash Paid" id="cash_paid" name="cash_paid" class="btn btn-primary">
 </center>
</form>  
</body>  
</html>  
