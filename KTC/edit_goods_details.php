...
<body>
 ...
 -->
       ...
       <form action="sql_edit_good.php" method="POST">  
                    
                            <center><h3 class="box-title">Edit Goods </h3> 
...
<?php
      ...
      $query_importer = "SELECT * FROM goods where id_goods='".$_POST['name']."'";
...
<tr><td>Good ID:</td> <td><input type="text" readonly="readonly" class="form-control" id="good_id" name="good_id" value="'.$row['id_goods'].'"></td></tr>

                               <tr><td>Good Name:</td> <td><input type="text" class="form-control" id="good_name" name="good_name" value="'.$row['goods_name'].'">';
echo '</td></tr>
<tr><td>HSN Code:</td> <td><input type="text" class="form-control" id="hsn_code" name="hsn_code" value="'.$row['HSN_code'].'"></td></tr>
<tr><td>Our Rate:</td> <td><input type="number" step="any" class="form-control" id="our_rate" name="our_rate" value="'.$row['our_rate'].'" required></td></tr>

<tr><td>GST in Percent:</td> <td><input type="number" step="any" class="form-control" id="gst_per" name="gst_per" value="'.$row['gst_in_per'].'" required></td></tr>
...
?>
<br><br>
<input type="submit" value="Edit Good" id="edit_good" name="edit_good" class="btn btn-primary">
 </center>
</form>  
</body>  
</html>  
