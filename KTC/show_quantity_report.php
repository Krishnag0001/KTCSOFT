...
$query_importer = "SELECT * FROM goods_quantity";
...
$query_importer2 = "SELECT * FROM goods where id_goods='".$row["id_good"]."' limit 1";
...
<td style="text-align:center">';
if($row["goods_quantity"]<=5)
{
echo '<font color="red"><b>'.$row["goods_quantity"].'<b></font>';
}
else
{
 echo $row["goods_quantity"];
}
echo '</td></tr>';
