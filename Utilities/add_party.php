...
<body>
 ...
 -->
       ...
       <form action="sql_add_party.php" method="POST">  
                    
                            <center><h3 class="box-title">Add Party </h3> 
...
<?php
      ...
      include 'config.php';
                               ...
                               echo '<table width="400px"><tr><td>Party Name:</td> <td><input type="text" class="form-control" id="party_name" name="party_name" required>';
echo '</td></tr>
<tr><td>Party Address:</td> <td><input type="text" class="form-control" id="party_address" name="party_address" required></td></tr>

<tr><td>Party Mobile No.:</td> <td><input type="number" class="form-control" id="party_mobile_no" name="party_mobile_no" required></td></tr>

<tr><td>Party GST/PAN/Adhar No.:</td> <td><input type="text" class="form-control" id="party_gst" name="party_gst"></td></tr>
</table>';
?>
<br><br>
<input type="submit" value="Create Account" id="view_bill" name="view_bill" class="btn btn-primary">
 </center>
</form>  
</body>  
</html>  
