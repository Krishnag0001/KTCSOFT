...
<li  class="dropdown"><a href="add_customer.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Create Account <span class="caret"></span></a>
 ...
 -->
       ...
       <form action="show_view_expence.php" method="POST">  
                    
                            <center><h3 class="box-title">View Expences </h3> 
...
<?php
      ...
      include 'config.php';
                               ...
                               echo '<table width="400px"><tr><td>From Date:</td> <td><input type="date" class="form-control" id="date1" name="date1">';
echo '</td></tr><td>To Date:</td> <td><input type="date" class="form-control" id="date2" name="date2"></td></tr></table>';
?>
<br><br>
<input type="submit" value="View Expences" id="view_bill" name="view_bill" class="btn btn-primary">
 </center>
</form>  
</body>  
</html>  
