...
$query_importer = "SELECT * FROM replace_goods";
...
$query_importer2 = "SELECT * FROM goods where id_goods='".$row["good_id"]."' limit 1";
...
$query_importer2 = "SELECT * FROM party where id_party='".$row["party_id"]."' limit 1";
      $result_importer2 = mysqli_query($conn,$query_importer2);
if(mysqli_num_rows($result_importer2) > 0)
{
    while($row2 = mysqli_fetch_assoc($result_importer2))
