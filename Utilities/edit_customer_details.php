...
<body>
 ...
 -->
       ...
       <form action="sql_edit_customer.php" method="POST">  
                    
                            <center><h3 class="box-title">Edit Customer </h3> 
...
<?php
      ...
      //DB Config
      include 'config.php';
      $query_importer = "SELECT * FROM customer where id_customer='".$_POST['name']."'";
...
<tr><td>Customer ID:</td> <td><input type="text" readonly="readonly" class="form-control" id="customer_id" name="customer_id"  value="'.$_POST['name'].'" >
</td></tr>

                               <tr><td>Customer Name:</td> <td><input type="text" class="form-control" id="customer_name" name="customer_name"  value="'.$row['customer_name'].'">';
echo '</td></tr>
<tr><td>Customer Address:</td> <td><input type="text" class="form-control" id="customer_address" name="customer_address"  value="'.$row['customer_address'].'"></td></tr>

<tr><td>Customer Mobile No.:</td> <td><input type="number" class="form-control" id="customer_mobile_no" name="customer_mobile_no"  value="'.$row['customer_mobile_no'].'"></td></tr>

<tr><td>Customer GST/PAN/Adhar No.:</td> <td><input type="text" class="form-control" id="customer_gst" name="customer_gst"  value="'.$row['customer_GST_NO'].'"></td></tr>';
   }
}
...
?>
<br><br>
<input type="submit" value="Edit Customer" id="edit_customer" name="edit_customer" class="btn btn-primary">
 </center>
</form>  
</body>  
</html>  
