...
<body>
 ...
 -->
       ...
       <form action="ledger_account.php" method="POST">  
                    
                            <center><h3 class="box-title">View Ledger </h3> 
...
<?php
      ...
      $result_importer = mysqli_query($conn,$query_importer);
                               ...
                               echo '<table><tr><td>Customer Name:</td> <td><select name="name" id="name" class="form-control" style="width:400px;">
...
<br><br>
<input type="submit" value="View Ledger" id="ledger" name="ledger" class="btn btn-primary">
 </center>
</form>  
...
<form action="sql_add_to_ledger_account.php" method="POST">  
                    
                            <center><h3 class="box-title">Add Debit to Customer Ledger </h3> ';
...
echo '</select></td></tr>
<tr><td>Invoice No.:</td> <td><input type="text" step="any" class="form-control" id="invoice_no" name="invoice_no"></td></tr>
<tr><td>Amount:</td> <td><input type="number" step="any" class="form-control" id="amount" name="amount" required></td></tr>


<tr><td>Date:</td> <td><input type="date" class="form-control" id="date_id" name="date_id" value="'.date("Y-m-d").'"></td></tr>
</table>';


?>
<br><br>
<input type="submit" value="Add to Ledger" id="ledger" name="ledger" class="btn btn-primary">
 </center>
</form>  
</body>  
</html>  
