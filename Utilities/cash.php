...
echo '<tr><td>Cash Amount:</td><td> <input type="number" class="form-control" id="cash" name="cash" required></td></tr>';
echo '<tr><td>Date:</td><td> <input type="date" class="form-control" id="date1" name="date1" value="'.date("Y-m-d").'" required></td></tr></table>';
?>
<br><br>
