...
{  
//$_SESSION["customer_id"]=$_POST['name'];  
$sql = "INSERT INTO customer (customer_name, customer_address, customer_mobile_no)
          VALUES ('".$_POST["customer_name"]."','".$_POST['customer_address']."','".$_POST['customer_mobile_no']."')";
...
document.getElementById("qty_type1").value=spl[1];
...
document.getElementById("qty_type2").value=spl[1];
...
document.getElementById("qty_type3").value=spl[1];
...
document.getElementById("qty_type4").value=spl[1];
...
document.getElementById("qty_type5").value=spl[1];
...
document.getElementById("qty_type6").value=spl[1];
...
document.getElementById("qty_type7").value=spl[1];
...
document.getElementById("qty_type8").value=spl[1];
...
document.getElementById("qty_type9").value=spl[1];
...
document.getElementById("qty_type10").value=spl[1];
...
document.getElementById("qty_type11").value=spl[1];
...
document.getElementById("qty_type12").value=spl[1];
...
document.getElementById("qty_type13").value=spl[1];
...
document.getElementById("qty_type14").value=spl[1];
...
document.getElementById("qty_type15").value=spl[1];
...
<body>
 ...
 -->
                            ...
                            <center><h3 class="box-title">Bill </h3> 
...
if(mysqli_num_rows($result_importer) > 0)
{
    ...
    {
        echo $row['customer_name'].'<br>'.$row['customer_address'].'<br>'.$row['customer_mobile_no'];
    }
}
echo '</td></tr></table>
<br>
...
<td>
&nbsp&nbsp&nbspBill Date :-</td><td><input type="date" class="form-control" id="date_id" name="date_id" value="'.date("Y-m-d").'"> </td>
</tr></table>
</center>';
...
<table border="1"><tr><th height="30">Sr. No</th><th>Goods</th><th>Rate</th><th>Qty.</th><th>Unit</th><th>Total</th><th>Total</th></tr>
